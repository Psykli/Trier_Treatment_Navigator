...
class Profile extends CI_Controller 
{
    ...
    function __construct( )
    {
        ...
        if( $this->session_model->is_logged_in( $this->session->all_userdata() ) )
        {
            ...
            if( $this->data[CONTENT_STRING]['userrole'] !== 'user' && $this->data[CONTENT_STRING]['userrole'] !== 'privileged_user' && $this->data[CONTENT_STRING]['userrole'] !== 'supervisor' ) {
    ...
    public function index()
    {
        ...
        $this -> template -> set( CONTENT_STRING, 'user/profile', $this -> data[CONTENT_STRING] );
        ...
        if( !$this -> membership_model -> validate( $this->data[TOP_NAV_STRING]['username'], $current_password ) ) {
            ...
            if( !empty( $this -> data[CONTENT_STRING]['profile'] -> email ) ) {
                ...
                if( !$entered ) {
                    ...
                    $reset_link = site_url() . '/user/profile/change_email_confirmation/' . $reset_code;
    ...
    function change_email_confirmation( $confirmation_code, $confirm = null )
	{
        ...
        if( is_null( $confirmation_data ) ) {
            ...
            $this -> data[CONTENT_STRING]['accept_confirmation_link'] = site_url() . '/user/profile/change_email_confirmation/' . $confirmation_data -> confirmation_code . "/confirm";
        }
