...
class Profile extends CI_Controller 
{
     ...
     *  - or -  
     *      http://example.com/index.php/admin/profile/index
     *  - or -
    ...
    public function index( )
    {
        ...
        $this -> template -> set( CONTENT_STRING, 'admin/profile', $this -> data[CONTENT_STRING] );
        ...
        if( !$this -> membership_model -> validate( $this->data[TOP_NAV_STRING]['username'], $current_password ) ) {
            ...
            if( !empty( $this -> data[CONTENT_STRING]['profile'] -> email ) ) {
                ...
                if( !$entered ) {
                    ...
                    $reset_link = site_url() . '/admin/profile/change_email_confirmation/' . $reset_code;
    ...
    function change_email_confirmation( $confirmation_code, $confirm = null )
	{
        ...
        if( is_null( $confirmation_data ) ) {
            ...
            $this -> data[CONTENT_STRING]['accept_confirmation_link'] = site_url() . '/admin/profile/change_email_confirmation/' . $confirmation_data -> confirmation_code . "/confirm";
        }
