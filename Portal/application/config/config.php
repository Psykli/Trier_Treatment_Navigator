...
|
*/
$config['base_url'] = 'https://zpp-datenbank.psychologie.uni-greifswald.de/ttn/';
...
| Alle R Skripte m�ssen sich in diesem Ordner befinden.
|
|
*/
$config['r_path'] = '/var/www/ttn/application/third_party/r_skripte/';
...
|--------------------------------------------------------------------------
|
| The default password that gets used for accounts.
| Change to another random string for new installations.
*/
$config['default_password'] = 'defaultsecret';

/*
|--------------------------------------------------------------------------
| Message encryption constant
|--------------------------------------------------------------------------
|
| This constant gets concatenated with the randomKeyBytes stored in the 
| ex_nachrichten table which creates the decryption key for each message.
| Storing the whole key in the DB would be dangerous because then the hacker
| would have everything he needs to decrypt the messages in the DB and
| the encryption wouldn't be very useful.
| With this approach the hacker has to get a copy of the DB and the PHP code
| to decrypt the messages.
| Change to another random string for new installations.
*/
$config['msg_encryption_constant'] = '>}an9PT@oLAre';

/*
|--------------------------------------------------------------------------
| Message encryption key size
|--------------------------------------------------------------------------
|
| 32 = 256 bit
| It's recommended to leave it as it is.
*/
$config['msg_encryption_key_size'] = 32;
...
|--------------------------------------------------------------------------
|
| The algorithm used to encrypt the messages.
| It's recommended to leave it as it is.
*/
