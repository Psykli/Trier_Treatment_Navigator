										...
										foreach( $receivedMsgs as $msg ): ?>
											<?php if( $msg->status == 0 ): ?>
												<tr>
													...
													<td><strong><?php echo ( !empty( $msg->betreff ) )? anchor( 'admin/patient/showMessage/'.$msg->id, $msg->betreff ) : 'Kein Betreff'; ?></strong></td>
													<td><?php echo character_limiter( $msg->nachricht, 200).' '.anchor( 'admin/patient/showMessage/'.$msg->id ,'weiterlesen'); ?></td>
												</tr>		
										<?php endif; ?>
									<?php endforeach; ?>
								<tbody>
									...
									foreach( $receivedMsgs as $msg ): ?>
										<?php if( $msg->status == 1 ): ?>
											<tr>
												<td><?php echo date( 'd-m-Y <\b\r> H:i', strtotime( $msg->datum ) ); ?></td>
												<td><?php echo ( !empty( $msg->sender ) )? $msg->sender : 'Kein Sender'; ?></td>
												<td><?php echo ( !empty( $msg->betreff ) )? anchor( 'admin/patient/showMessage/'.$msg->id, $msg->betreff ) : 'Kein Betreff'; ?></td>
												<td><?php echo character_limiter( $msg->nachricht, 100).' '.anchor( 'admin/patient/showMessage/'.$msg->id ,'weiterlesen'); ?></td>
											</tr>		
										<?php endif; ?>
									<?php endforeach; ?>
								<tbody>
...
<div class="modal fade" id="msgModal" tabindex="-1" role="dialog" aria-labelledby="meinModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open( 'admin/patient/send_msg/', array('role'=>'form')); ?>
