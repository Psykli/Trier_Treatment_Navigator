...
<ul class="breadcrumb">
	<li><a href="<?php echo site_url( ).'/'.$userrole; ?>/dashboard">Dashboard</a></li>
...
<div class="row">
	<div class="col-lg-6 col-sm-12 bottom_spacer_25px">
		<a href="<?php echo site_url( 'admin/patient/messages' ); ?>" class="remove_text_decoration">
...
<p><?php echo anchor( 'admin/patient/messages', 'Zurück zu den Nachrichten' ); ?></p>
