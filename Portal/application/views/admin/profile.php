<!-- load the files for checking the password strength -->
<script src="<?php echo base_url(); ?>js/formValidationBootstrap.min.js" defer></script>
<script src="<?php echo base_url(); ?>js/zxcvbn.js" defer></script>
...
<div class="media bottom_spacer_50px">
    ...
    <div class="media-body">
        <h2 class="media-heading"><?php echo lang( 'admin_profile' ); ?></h2>
    </div>
</div>
...
<?php if( isset( $old_email_address ) && isset( $new_email_address_unconfirmed ) && isset( $accept_confirmation_link ) ): ?>
	<div class="alert alert-info">
        ...
        <a href="<?php echo site_url('admin/profile'); ?>" class="btn btn-outline-primary"><?php echo lang( 'email_address_change_cancel_button' ); ?></a>
	</div>
<?php endif; ?>

<div class="row">
	<div class="col">
		<?php echo form_open( 'admin/profile/change_email',  array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'emailForm' ) ); ?>

			<div class="form-group">
				<label for="initials" class="col-sm-8 col-lg-4 control-label"><?php echo lang( 'initials' ); ?> (Login)</label>
			...
			<div class="form-group">
				<label for="first_name" class="col-sm-8 col-lg-4 control-label"><?php echo lang( 'first_name' ); ?></label>
				<div class="col-sm-8 col-lg-4">
			...
			<div class="form-group">
				<label for="last_name" class="col-sm-8 col-lg-4 control-label"><?php echo lang( 'last_name' ); ?></label>
				<div class="col-sm-8 col-lg-4">
			...
			<div class="form-group">
				<label for="rolle" class="col-sm-8 col-lg-4 control-label"><?php echo lang( 'role' ); ?></label>
				<div class="col-sm-8 col-lg-4">
			...
			<div class="card col-sm-8 col-lg-4">
                <div class="card-body">
					...
					<div class="form-group">
						...
						<input type="email" class="form-control" id="email" name="email" value="<?php echo $profile -> email; ?>" placeholder="<?php echo $profile -> email; ?>">
					</div>
		...
		<?php echo form_open( 'admin/profile/change_password',  array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'passwordForm' ) ); ?>
			<div class="card col-sm-8 col-lg-4">
                <div class="card-body">
					<div class="form-group">
						<label for="current_password" class="control-label"><?php echo lang( 'current_password' ); ?></label>
