...
<nav class="menu">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="<?php echo base_url( ); ?>index.php/<?php echo $userrole; ?>/dashboard">Dashboard</a></li>
...
<div class="row">
	<div class="col-lg-6 col-sm-12 bottom_spacer_25px">
		<a href="<?php echo site_url( 'user/patient/messages' ); ?>" class="remove_text_decoration">
...
<p><?php echo anchor( 'user/patient/messages', 'Zurück zu den Nachrichten' ); ?></p>
