		...
		<div class="collapse navbar-collapse" id="navbar_1collapse_1">
			<ul class="nav navbar-nav">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Portal<b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li>
							<?php echo anchor('admin/meeting_tool/index/overview', 'Zuweisungstool'); ?>
						</li>
						<li>
							<?php echo anchor('admin/meeting_tool/index/patient_list', 'Patientenliste'); ?>
						</li>
					</ul>
				</li>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<?php echo anchor('user/profile', 'Mein Benutzerprofil'); ?>
						</li>
						<li>
...
<header id="header_container">
	<div class="logo_container">
		<div class="container">
			...
			<!--<img src="<?php //echo base_url(); ?>/img/header_logo_neu.png" class="img-responsive" alt="Logo">-->
		</div>
	</div>
