...
<head>
    ...
    <!--
		<link rel="stylesheet" href="<?php echo base_url(); ?>css/video-js.min.css" type="text/css" media="screen" charset="utf-8">	
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>js/form-builder.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>js/form-render.min.js"></script>
