...
<div class="list-group w-100">
    ...
    <?php foreach ($batterie as $key => $quest): ?>   
        ...
        <?php if(($section_order == 0 AND $section != $active_section) OR ($section == $active_section AND $step == $key)):?>
            ...
            <?php if( $is_immutable AND $quest->gas_section == $count_section AND ($instance-1) % 5 == 0 AND ($instance-1) != 5 AND $pr_exists ):?>
...
<div class="modal-content">
  ...
  <div class="modal-footer">
    <button type="button" id="modal_close" class="btn btn-outline-secondary" data-dismiss="modal"><?php echo lang('close');?></button>
  </div>
</div>
</div>
</div>
