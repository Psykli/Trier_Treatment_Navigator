...
<div class="row">
	<div class="col">
        <?php echo form_open( 'patient/profile/change_email',  array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'emailForm' ) ); ?>
		...
		<?php echo form_open( 'patient/profile/change_password',  array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'passwordForm' ) ); ?>
            <div class="card col-sm-8 col-lg-4">
                <div class="card-body">
                    <div class="form-group">
                        <label for="current_password" class="control-label"><?php echo lang( 'current_password' ); ?></label>
