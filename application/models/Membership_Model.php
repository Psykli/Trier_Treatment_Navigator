...
class Membership_model extends CI_Model
{
    ...
    */
    ...
    public function generate_random_password ( $length = 8, $keyspace = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!"#$%&\'()*+,-./' )
    {
        ...
        for ($i = 0; $i < $length; ++$i) {
            $new_password .= $keyspace[random_int(0, $max)];
        }
