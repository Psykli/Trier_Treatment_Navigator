<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo base_url(); ?>index.php/patient/dashboard">Feedbacksystem</a>
		</div>
		
		<div class="collapse navbar-collapse" id="navbar_1collapse_1">
		
			<ul class="nav navbar-nav">
				<?php if(!$this->Questionnaire_tool_model->is_questionnaire_available($username)): ?> 
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">                  
						<li>
							<?php echo anchor( "patient/patient/index/exercises/", 'Übungen' ); ?>
						</li>
					</ul>
