<div class="media bottom_spacer">
	...
	<div class="media-body">
		<h2 class="media-heading"><?php echo lang('details_details');?>	<?php  echo "Code: ";  echo $patient[0]->code; ?></h2>
	</div>
</div>
...
<div class="panel panel-default">
	<div class="panel-body">
		<ul class="nav nav-pills">		
			...
			<!--GAS-->
			<li>
				<?php $link = 'index.php/' . 'user/Gas_Tool/create_gas/' . $patient[0]->code; ?>
		...
		<?php //if($rechte_nn): ?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?php $link = 'index.php/' . 'user/patient/diagnostiktool/' . $patient[0]->code; ?>
					<?php 
					if($viewColor == 'red'):?>
								...
								<?php foreach( $status as $entry ): ?>
									<tr>
										<td style="text-align: center;">
											<?php $link = $userrole . '/status/status/' . $entry->instance . '/' . $patient[0]->code;
	...
	<div class="col-sm-6">	
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="media">
					<?php 
					$link = site_url().'/user/feedback/overview/'.$patient[0]->code; 
					if($color == 'red'):?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">				
				...
				<!-- <h3>Gesamt</h3> -->
				<?php $link = 'index.php/user/status/process/' . $patient[0]->code ; ?>
				...
				<?php foreach( $status as $entry ): ?>
					<?php if(strcmp("PO", $entry->instance) == 0): ?>
						<?php $link = 'index.php/user/status/process/' . $patient[0]->code . '/pr_po_comparison'; ?>
